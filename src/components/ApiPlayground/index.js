      ...
      <div className={styles.body}>
        {pathParams.length > 0 && (
          <>
            ...
            {pathParams.map(f => (
              <Field key={f.name} f={f} values={values} setValue={setValue} isPath />
            ))}
        ...
        {bodyFields.length > 0 && (
          <>
            ...
            {bodyFields.map(f => (
              <Field key={f.name} f={f} values={values} setValue={setValue} />
            ))}
          </>
        )}
...
function Field({ f, values, setValue, isPath }) {
  return (
